...
export const MessageInput: FC<Props> = ({recipientId}) => {
	...
	return (
			<div className="w-full flex items-center justify-between p-2 shadow-2xl fixed bottom-0 bg-white">
				{isPlaceholderNeeded && (
				...
				<div
						...
						role="textbox"
						className="whitespace-pre-wrap break-words w-full p-2 z-10 pr-12 outline-none"
				...
				<div className="absolute right-2 z-20">
					{text ?
							<button className="m-2" onClick={() => dispatch(createMessage({text, recipientId}))}>
								...
								<button className="m-2">
									<svg className="text-inherit fill-current h-6" viewBox="0 0 24 24">
										<path fillRule="evenodd" clipRule="evenodd"
													d="M12 0C12.2652 0 12.5196 0.105357 12.7071 0.292893C12.8946 0.48043 13 0.734784 13 1V11H23C23.2652 11 23.5196 11.1054 23.7071 11.2929C23.8946 11.4804 24 11.7348 24 12C24 12.2652 23.8946 12.5196 23.7071 12.7071C23.5196 12.8946 23.2652 13 23 13H13V23C13 23.2652 12.8946 23.5196 12.7071 23.7071C12.5196 23.8946 12.2652 24 12 24C11.7348 24 11.4804 23.8946 11.2929 23.7071C11.1054 23.5196 11 23.2652 11 23V13H1C0.734784 13 0.48043 12.8946 0.292893 12.7071C0.105357 12.5196 0 12.2652 0 12C0 11.7348 0.105357 11.4804 0.292893 11.2929C0.48043 11.1054 0.734784 11 1 11H11V1C11 0.734784 11.1054 0.48043 11.2929 0.292893C11.4804 0.105357 11.7348 0 12 0V0Z"/>
									</svg>
								</button>
								<button className="m-2">
									<svg className="text-inherit fill-current h-6" viewBox="0 0 24 24">
